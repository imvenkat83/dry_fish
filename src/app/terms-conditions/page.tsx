      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-12">
        ...
        <div className="space-y-8 text-sm text-black/85 leading-relaxed font-medium bg-white p-8 md:p-12 rounded-3xl border border-[#8c6239]/10 shadow-sm">
          ...
          <div className="space-y-3 border-t border-[#8c6239]/10 pt-6">
            ...
            <p>
              These terms shall be governed by and defined following the laws of India. Dry Fish Basket and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
            </p>
          </div>
          ...
          <div className="space-y-3 border-t border-[#8c6239]/10 pt-6">
            ...
            <h3 className="text-base font-bold text-[#3b2314]">Informal Negotiations</h3>
            <p>
            ...
            <h3 className="text-base font-bold text-[#3b2314] pt-2">Binding Arbitration</h3>
            <p>
              Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by arbitration in accordance with applicable Indian arbitration laws. The language of the proceedings shall be English or Telugu. The governing law of the contract shall be the substantive law of India.
            </p>

            <h3 className="text-base font-bold text-[#3b2314] pt-2">Restrictions</h3>
            <p>
              The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
            </p>

            <h3 className="text-base font-bold text-[#3b2314] pt-2">Exceptions to Informal Negotiations and Arbitration</h3>
            <p>
          ...
          <div className="space-y-3 border-t border-[#8c6239]/10 pt-6">
            ...
            <p className="uppercase text-xs leading-relaxed font-semibold">
          ...
          <div className="space-y-3 border-t border-[#8c6239]/10 pt-6">
            ...
            <ul className="space-y-2.5 font-semibold text-[#3b2314]">
              <li className="font-bold text-[#8c6239] text-base">Dry Fish Basket</li>
